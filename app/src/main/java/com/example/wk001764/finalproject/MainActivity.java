...
import com.example.wk001764.finalproject.Match.MatchesActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flingContainer.setFlingListener(new SwipeFlingAdapterView.onFlingListener() {
            ...
            public void onLeftCardExit(Object dataObject) {
                ...
                usersDb.child(userId).child("connections").child("pass").child(currentUId).setValue(true);
            ...
            public void onRightCardExit(Object dataObject) {
                cards obj = (cards) dataObject;
                String userId = obj.getUserId();
                usersDb.child(userId).child("connections").child("play").child(currentUId).setValue(true);
    ...
    private void isConnectionMatch(String userId) {
        DatabaseReference currentUserConnectionsDb = usersDb.child(currentUId).child("connections").child("play").child(userId);
    ...
    public void checkUserSex(){
        ...
        userDb.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    if (dataSnapshot.child("Sport"). getValue() != null){
